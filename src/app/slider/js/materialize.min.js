...
window.cash = function () {
  ...
  _.prefixedProp = j, _.camelCase = W, y.extend({
    css: function (e, i) {
      if (d(e)) {
        return e = j(e), 1 < arguments.length ? this.each(function (t) {
          return t.style[e] = i;
...
M.anime = function () {
  ...
  M.updateTextFields = function () {
    ...
    d(document).on("keyup", "input[type=radio], input[type=checkbox]", function (t) {
      if (t.which === M.keys.TAB) {
        return d(this).addClass("tabbed"), void d(this).one("blur", function (t) {
  ...
  var e = {
    ...
    return _inherits(i, Component), _createClass(i, [{
      ...
      key: "_handleCarouselRelease", value: function (t) {
        if (this.pressed) {
          return this.pressed = !1, clearInterval(this.ticker), this.target = this.offset, (10 < this.velocity || this.velocity < -10) && (this.amplitude = .9 * this.velocity, this.target = this.offset + this.amplitude), this.target = Math.round(this.target / this.dim) * this.dim, this.noWrap && (this.target >= this.dim * (this.count - 1) ? this.target = this.dim * (this.count - 1) : this.target < 0 && (this.target = 0)), this.amplitude = this.target - this.offset, this.timestamp = Date.now(), requestAnimationFrame(this._autoScrollBound), this.dragged && (t.preventDefault(), t.stopPropagation()), !1;
        }
      }
    }, {
      ...
      key: "_handleOptionClick", value: function (t) {
        ...
        if (!d(e).hasClass("disabled") && !d(e).hasClass("optgroup") && i.length) {
          ...
          if (this.isMultiple) {
            ...
            d(this.dropdownOptions).find("li").removeClass("selected"), d(e).toggleClass("selected", n);
          }
